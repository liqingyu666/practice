            ...
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 @endif
                    <td><a href="#" data-toggle="modal" data-target="#edit" class="btn btn-success" role="button" onclick="edit({{$value->id}})">编辑</a><a href="javascript:;" onclick="deletes(this,{{$value->id}})" class="btn btn-danger" role="button">删除</a></td>
