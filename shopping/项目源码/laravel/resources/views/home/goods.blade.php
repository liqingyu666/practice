	...
	<body>
			...
			<div class="nav-table">
				...
				<ol class="am-breadcrumb am-breadcrumb-slash">
					<li><a href="#">首页</a></li>
					<li><a href="#">商品详情</a></li>
					<li class="am-active">{{$goods->title}}</li>
				</ol>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								...
								<a href=""><img src="/Uploads/goods/{{$goods->img}}" alt="细节展示放大镜特效" rel="/Uploads/goods/{{$goods->img}}" class="jqzoom" /></a>
							...
							<ul class="tb-thumb" id="thumblist">
								...
								<li class="tb-selected">
									...
									<div class="tb-pic tb-s40">
										...
										<a href="#"><img style="width: 60px;height: 60px;" src="/Uploads/goods/{{$img->img}}" mid="/Uploads/goods/{{$img->img}}" big="/Uploads/goods/{{$img->img}}"></a>
											...
											<div class="am-comment-main">
												...
												<header class="am-comment-hd">
													...
													<div class="am-comment-meta">
														...
														<!-- 评论者 -->
														评论于
														<time datetime="">{{date("Y-m-d H:i:s",$com->time)}}</time>
														<span>{{str_repeat("★",$com->start)}}{{str_repeat("☆",5-$com->start)}}</span>
													</div>
												</header>
