...
<meta name="description" content="{{config('web.description')}}" />
	<link type="text/css" rel="stylesheet" href="/style/home/css/style.css" />
    <!--[if IE 6]>
    ...
    <![endif]-->    
    <script type="text/javascript" src="/style/home/js/jquery-1.11.1.min_044d0927.js"></script>
	<script type="text/javascript" src="/style/home/js/jquery.bxslider_e88acd1b.js"></script>
    
    <script type="text/javascript" src="/style/home/js/jquery-1.8.2.min.js"></script>
    <script type="text/javascript" src="/style/home/js/menu.js"></script>    
        
	<script type="text/javascript" src="/style/home/js/select.js"></script>
    
	<script type="text/javascript" src="/style/home/js/lrscroll.js"></script>
    
    <script type="text/javascript" src="/style/home/js/iban.js"></script>
    <script type="text/javascript" src="/style/home/js/fban.js"></script>
    <script type="text/javascript" src="/style/home/js/f_ban.js"></script>
    <script type="text/javascript" src="/style/home/js/mban.js"></script>
    <script type="text/javascript" src="/style/home/js/bban.js"></script>
    <script type="text/javascript" src="/style/home/js/hban.js"></script>
    <script type="text/javascript" src="/style/home/js/tban.js"></script>
    
	<script type="text/javascript" src="/style/home/js/lrscroll_1.js"></script>
...
<div class="top">
    <div class="logo"><a href="Index.html"><img src="Uploads/sys/{{config("web.logo")}}" /></a></div>
    <div class="search">
    	<form>
...
<div class="i_bg bg_color">
    	...
    	<div class="banner">    	
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    ...
                    <li><img src="Uploads/lun/{{$value->img}}" width="740" height="401" /></li>
    ...
    <div class="content mar_10">
    	<div class="h_l_img">
        	<div class="img"><img src="/style/home/images/l_img.jpg" width="188" height="188" />
            </div>
        </div>
        <div class="hot_pro">        	
                    ...
                    <div id="block">
                        <div id="botton-scroll">
                            <ul class="featureUL">
                                ...
                                <li class="featureBox">
                                    <div class="box">
                                    	<div  class="h_icon"><img src="/style/home/images/hot.png" width="50" height="50" /></div>
                                        <div class="imgbg" style="margin-top: 40px">
                                        	<a href="#"><img src="/Uploads/ads/{{$value->img}}" width="160" height="136" /></a>
                                        </div>                                        
                                        <div class="name">
                                        	<a href="#">
                                            {{$value->title}}
