        ...
        <div class="widget-content nopadding">
          <form action="/admin/sys/config" method="post" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="title" value="<?php echo e(config('web.title')); ?>" class="span11" placeholder="title" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">KEYWORDS :</label>
              <div class="controls">
                <input type="text" name="keywords" value="<?php echo e(config('web.keywords')); ?>" class="span11" placeholder="友情链接" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">description :</label>
              <div class="controls">
                <input type="text" name="description" value="<?php echo e(config('web.description')); ?>" placeholder="数值越大越靠前">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="baidu"  id="" cols="30" class="form-control" rows="10"><?php echo e(config('web.baidu')); ?></textarea>
              </div>
            </div>
             <div class="control-group">
              ...
              <div class="controls">
                ...
                <div id="main">
                  <img src="/Uploads/sys/<?php echo e(config('web.logo')); ?>" style="width: 200px" alt="">
                </div>
